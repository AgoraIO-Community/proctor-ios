Pod::Spec.new do |spec|
  ...
  spec.version      = "2.8.127-hello"
    ...
    spec.source              = { :git => "git@github.com:AgoraIO-Community/proctor-ios.git", :tag => "AgoraProctorUI_v" + "#{spec.version.to_s}" }
    spec.public_header_files = "SDKs/AgoraProctorUI/Classes/**/*.h"
    spec.source_files        = "SDKs/AgoraProctorUI/Classes/**/*.{h,m,swift}"

    # Agora libs
  spec.dependency "AgoraUIBaseViews", "=2.8.127-hello"
  spec.dependency "AgoraEduCore", "=2.8.127-hello"
